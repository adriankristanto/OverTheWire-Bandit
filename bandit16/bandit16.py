...
print('nmap -sV -p31000-32000 localhost')
...
print(f'echo {PASSWORD} | openssl s_client -connect localhost:31790 -ign_eof')
...
print('writing the private key file of bandit17...\n')
...
print('change private key file permission to 600...\n')
...
print('cat /etc/bandit_pass/bandit17')
...
print(f'bandit17 password: {password}')
